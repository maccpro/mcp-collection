...
| [`code-impact-analyzer`](./servers/code-impact-analyzer) | Enterprise Dynamic Code Impact Analysis, Blast Radius Calculator & Breaking Change Detector | stdio (JSON-RPC 2.0) | Node.js (Zero external dependencies) |
