...
| [`code-impact-analyzer`](./servers/code-impact-analyzer) | Enterprise Neuro-Symbolic Code Impact Analysis, Blast Radius Calculator, Runtime Hazard Evaluator & Cognitive Reasoning Engine | stdio (JSON-RPC 2.0) | Node.js (Zero external dependencies) |
...
| [`ui-ux-mcp`](./servers/ui-ux-mcp) | Enterprise Frontend UI/UX Design System, WCAG 2.2 Heuristic Audit, Dynamic Tokens, Color Math & Multi-Framework Converter | stdio (JSON-RPC 2.0) | Node.js (Zero external dependencies) |
...
└── servers/
    ...
    │   ├── .env.example
    │   └── README.md
    ├── code-impact-analyzer/ # Dynamic Code Impact Analysis & Blast Radius Engine
    │   ├── server.js
    │   ├── package.json
    │   ├── .env.example
    │   ├── README.md
